...
// Documents légaux (CGU, politique de confidentialité, consignes de sécurité).
// Modifiables par l'admin via /api/admin/legal/:key (voir plus bas), sans redéploiement —
// même logique que la taxonomie ou les comptes marchands. Texte de départ raisonnable,
// à faire relire par un juriste avant mise en production réelle : ceci n'est pas un
// conseil juridique, seulement une base de travail couvrant les points essentiels
// d'une plateforme d'intermédiation de services en Côte d'Ivoire.
let legalDocs = readDB("legal_docs", {
  cgu: {
    title: "Conditions Générales d'Utilisation (CGU)",
    updatedAt: Date.now(),
    content: `1. OBJET
MIMOYE est une plateforme numérique de mise en relation entre des clients particuliers
ou professionnels et des prestataires de services indépendants ("les professionnels").
MIMOYE n'est ni l'employeur, ni le mandataire, ni le garant des professionnels référencés :
elle facilite la mise en relation, la prise de rendez-vous et le paiement, mais n'exécute
elle-même aucune prestation de service.

2. INSCRIPTION ET COMPTE
L'inscription nécessite un email valide et un mot de passe. Chaque utilisateur est
responsable de la confidentialité de ses identifiants et de l'exactitude des informations
fournies. MIMOYE peut suspendre ou supprimer un compte en cas de fraude, de fausse
déclaration, de comportement abusif ou de non-respect des présentes CGU.

3. RÔLE DES PROFESSIONNELS
Les professionnels inscrits sont des prestataires indépendants. Leur inscription peut être
soumise à vérification (badge "vérifié") mais cela ne constitue pas une garantie absolue
de compétence, de qualité ou d'honnêteté. Le client reste libre d'accepter ou refuser un
devis avant tout engagement financier.

4. PAIEMENT ET COMMISSION
Les paiements s'effectuent via Mobile Money (Wave, Orange Money, MTN Money, Moov Money)
sur un compte marchand MIMOYE communiqué dans l'application, ou via l'API de paiement
correspondante lorsqu'elle est active. MIMOYE prélève une commission sur chaque prestation
payée avant de reverser le solde au professionnel, selon les taux affichés dans l'application.
Aucun paiement ne doit être effectué en dehors des circuits indiqués dans l'application :
MIMOYE ne peut être tenue responsable d'un paiement effectué à un numéro non communiqué
par la plateforme.

5. LITIGES ET SIGNALEMENTS
Tout désaccord sur une prestation (qualité, retard, non-exécution) peut faire l'objet d'un
signalement depuis l'application ("Signaler un problème"). MIMOYE examine chaque litige de
bonne foi mais n'est pas partie au contrat de prestation entre le client et le professionnel,
et sa responsabilité ne saurait être engagée au-delà de son rôle d'intermédiaire et de
médiateur.

6. DONNÉES PERSONNELLES
Les données collectées (nom, contact, localisation le cas échéant) sont utilisées uniquement
pour le fonctionnement du service (mise en relation, paiement, sécurité, support). Les
coordonnées privées (téléphone, WhatsApp, email, informations de paiement) ne sont jamais
affichées publiquement et ne sont partagées entre client et professionnel qu'après acceptation
mutuelle d'une mise en relation. Voir la Politique de confidentialité pour le détail.

7. COMPORTEMENTS INTERDITS
Sont interdits : la fraude, l'usurpation d'identité, le harcèlement, la publication de faux
avis, la tentative de contournement du paiement via l'application, ainsi que toute utilisation
illégale de la plateforme. Ces comportements peuvent entraîner la suspension immédiate du
compte, sans préjudice d'éventuelles poursuites.

8. RESPONSABILITÉ
MIMOYE met tous les moyens raisonnables en œuvre pour assurer la disponibilité et la
sécurité de la plateforme, sans garantie de disponibilité continue. MIMOYE ne saurait être
tenue responsable des dommages indirects résultant de l'utilisation du service ou d'une
prestation réalisée par un professionnel tiers.

9. DROIT APPLICABLE
Les présentes CGU sont soumises au droit ivoirien. Tout litige relatif à leur interprétation
ou leur exécution relève, à défaut de résolution amiable, des juridictions compétentes de
Côte d'Ivoire.

10. CONTACT
Pour toute question relative aux présentes CGU : "Contacter MIMOYE" depuis l'application.`
  },
  confidentialite: {
    title: "Politique de confidentialité",
    updatedAt: Date.now(),
    content: `MIMOYE collecte uniquement les données nécessaires au fonctionnement du service :
identité, contact, localisation (si vous l'autorisez), historique de vos demandes et
paiements. Ces données ne sont jamais vendues à des tiers.

COORDONNÉES PRIVÉES : téléphone, WhatsApp, email personnel et informations de paiement
d'un professionnel ne sont jamais affichés publiquement sur son profil. Elles ne sont
communiquées au client qu'après acceptation d'une demande, uniquement pour permettre la
réalisation de la prestation.

LOCALISATION : la position GPS n'est utilisée que si vous choisissez de l'activer, pour
trier les professionnels par proximité ou indiquer un lieu d'intervention. Elle n'est
jamais partagée publiquement.

CONSERVATION : les données sont conservées pendant la durée d'utilisation du compte, puis
supprimées ou anonymisées dans un délai raisonnable après suppression du compte, sauf
obligation légale de conservation plus longue (ex. données comptables).

VOS DROITS : vous pouvez demander l'accès, la rectification ou la suppression de vos
données personnelles en contactant MIMOYE depuis l'application.`
  },
  securite: {
    title: "Conseils de sécurité",
    updatedAt: Date.now(),
    content: `POUR LES CLIENTS
• Ne payez jamais un professionnel directement en dehors de l'application : utilisez
  uniquement le numéro marchand Mobile Money communiqué dans MIMOYE.
• Ne communiquez jamais votre code secret Mobile Money à qui que ce soit, y compris à un
  professionnel ou à une personne se présentant comme membre de l'équipe MIMOYE.
• Vérifiez le badge "vérifié" du professionnel avant d'accepter un devis, sans que cela
  dispense d'une vigilance normale (identité, avis, cohérence du tarif).
• Signalez immédiatement depuis l'application tout comportement suspect, toute demande de
  paiement anormale ou tout message vous demandant de sortir de la plateforme.

POUR LES PROFESSIONNELS
• MIMOYE ne vous demandera jamais votre mot de passe par téléphone, SMS ou WhatsApp.
• Vérifiez que le paiement du client apparaît confirmé dans l'application avant de
  considérer la prestation comme payée.
• Signalez tout client abusif ou toute tentative de paiement en dehors de l'application.

EN CAS DE DOUTE
Utilisez le bouton "Signaler un problème" ou "Contacter MIMOYE" — ne réglez jamais un
désaccord financier en dehors de l'application.`
  }
});
function saveLegalDocs() { writeDB("legal_docs", legalDocs); }
...
// Distance approximative à vol d'oiseau (km) entre deux points GPS — utilisée pour
// trier les professionnels par proximité quand le client partage sa position.
...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    // ================= AUTH =================
    // ================= DOCUMENTS LÉGAUX (CGU, confidentialité, sécurité) =================
    if (pathname === "/api/legal" && method === "GET") {
      return sendJSON(res, 200, legalDocs);
    }
    const legalMatch = pathname.match(/^\/api\/admin\/legal\/(cgu|confidentialite|securite)$/);
    if (legalMatch && method === "PUT") {
      const user = requireAuth(); if (!user) return;
      if (!requireRole(user, ["admin"])) return;
      const body = await readBody(req);
      const key = legalMatch[1];
      if (!body.content || !String(body.content).trim()) return sendJSON(res, 400, { error: "Contenu requis." });
      legalDocs[key] = { title: (body.title || legalDocs[key].title), content: String(body.content), updatedAt: Date.now() };
      saveLegalDocs();
      log("legal_doc_updated", user.id, { key });
      return sendJSON(res, 200, { ok: true, doc: legalDocs[key] });
    }
    ...
    if (pathname === "/api/auth/register" && method === "POST") {
      ...
      if (!body.acceptedTerms) {
        return sendJSON(res, 400, { error: "Vous devez accepter les Conditions Générales d'Utilisation pour créer un compte." });
      }
      if (users.find(u => u.email === email)) {
        return sendJSON(res, 409, { error: "Un compte existe déjà avec cet email." });
      }
      const { salt, hash } = hashPassword(password);
      const user = { id: newId("u"), email, salt, hash, role, name, phone, cguAcceptedAt: Date.now(), createdAt: Date.now() };
      users.push(user);
    ...
    if (pathname === "/api/professionals" && method === "GET") {
      ...
      const clientLat = q.lat !== undefined ? Number(q.lat) : null;
      const clientLng = q.lng !== undefined ? Number(q.lng) : null;
      let out = list.map(publicPro);
      if (clientLat !== null && clientLng !== null && !isNaN(clientLat) && !isNaN(clientLng)) {
        out = out.map(p => Object.assign({}, p, { distanceKm: distanceKm(clientLat, clientLng, p.lat, p.lng) }));
        // Les professionnels sans coordonnées GPS (distanceKm null) restent affichés, mais en dernier.
        out.sort((a, b) => (a.distanceKm === null ? Infinity : a.distanceKm) - (b.distanceKm === null ? Infinity : b.distanceKm));
      }
    ...
    if (pathname === "/api/professionals/register" && method === "POST") {
      ...
      // Coordonnées GPS optionnelles (position partagée par le professionnel depuis son
      // téléphone). Arrondies à 2 décimales (~1 km) : suffisant pour trier par proximité,
      // sans exposer une localisation trop précise du domicile/atelier du professionnel.
      const lat = (typeof body.lat === "number" && !isNaN(body.lat)) ? Math.round(body.lat * 100) / 100 : null;
      const lng = (typeof body.lng === "number" && !isNaN(body.lng)) ? Math.round(body.lng * 100) / 100 : null;
      ...
      if (existing) {
        Object.assign(existing, { metier, zone, tel, whatsapp, emailPro, tarif: tarif || existing.tarif, momoOperator: momoOperator || existing.momoOperator, momoNumber: momoNumber || existing.momoNumber, lat: lat !== null ? lat : existing.lat, lng: lng !== null ? lng : existing.lng, badge: "attente" });
      } else {
        existing = { id: newId("p"), userId: user.id, name: user.name, metier, zone, tel, whatsapp, emailPro, tarif: tarif || "Non renseigné", momoOperator, momoNumber, lat, lng, badge: "attente", note: 0, avis: 0, init };
    ...
    if (pathname === "/api/requests" && method === "POST") {
      ...
      const clientLat = (typeof body.clientLat === "number" && !isNaN(body.clientLat)) ? body.clientLat : null;
      const clientLng = (typeof body.clientLng === "number" && !isNaN(body.clientLng)) ? body.clientLng : null;
      const clientZone = (body.clientZone || "").trim(); // adresse/zone saisie manuellement si pas de GPS
      const reqObj = {
        ...
        clientLat, clientLng, clientZone,
